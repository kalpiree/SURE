...
#     # General
#     parser.add_argument('--dataset', type=str, required=True, help='Dataset name prefix (e.g. taobao)')
...
# def run_phase(phase_idx, args, model_ckpt=None):
#     phase_name = f'phase{phase_idx}'
    
#     train_file = os.path.join('phased_data', f'taobao_phase{phase_idx}.txt')
#     eval_file = os.path.join('phased_data', f'taobao_phase{phase_idx}_eval.csv')



#     # Load interactions and sequence transform
#     train_data = Interactions(train_file)
#     train_data.to_sequence(args.L, args.T)

#     # test_data = Interactions(eval_file,
...
#     # Save checkpoint
#     phase_dir = os.path.join(args.save_dir, f"{args.dataset}_caser")
#     os.makedirs(phase_dir, exist_ok=True)
#     ckpt_path = os.path.join(phase_dir, f'{phase_name}_model.pth')
#     recommender.save(ckpt_path)
#     print(f"✅ Saved: {ckpt_path}")

#     # Evaluate
#     out_csv = os.path.join(phase_dir, f'{phase_name}_eval_output.csv')
#     # evaluate_from_file(recommender, eval_file, out_csv, args)
...
#     # Optional: Print key metrics if returned
...
#         print(f"\n===== 🔁 Phase {i} =====")
#         prev_ckpt = run_phase(i, args, model_ckpt=prev_ckpt)
